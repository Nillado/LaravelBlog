            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->author->getAvatar()}}" class="pull-left img-circle" alt="" width="120">
                        ...
                        @foreach ($post->getComments() as $comment)
                            <div class="bottom-comment"><!--bottom comment-->
                                <div class="comment-img">
                                    <img class="img-circle" src="{{$comment->author->getAvatar()}}" alt="" width="80" height="60">
                                </div>
                    ...
                    @if (Auth::check())
                        <div class="leave-comment"><!--leave comment-->
                            ...
                            <form class="form-horizontal contact-form" role="form" method="post" action="/comment">
                                ...
                                <button href="#" class="btn send-btn">Post Comment</button>
                            </form>
